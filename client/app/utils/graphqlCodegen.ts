...
export type GetCompanyQuery = { __typename?: 'Query', company: { __typename?: 'Company', slug: string, name: string, headquarters: string, description: string | null, users: { __typename?: 'UserConnection', edges: Array<{ __typename?: 'UserEdge', cursor: string, node: { __typename?: 'User', slug: string, firstName: string, lastName: string, credentials: string | null } | null } | null> | null, pageInfo: { __typename?: 'PageInfo', hasNextPage: boolean, hasPreviousPage: boolean, startCursor: string | null, endCursor: string | null } } } | null };
...
export type GetPostQuery = { __typename?: 'Query', post: { __typename?: 'Post', body: string, createdAt: string, updatedAt: string, user: { __typename?: 'User', slug: string, firstName: string, lastName: string, credentials: string | null } } };
...
export type GetUsersQuery = { __typename?: 'Query', users: { __typename?: 'UserConnection', edges: Array<{ __typename?: 'UserEdge', cursor: string, node: { __typename?: 'User', slug: string, firstName: string, lastName: string, credentials: string | null } | null } | null> | null, pageInfo: { __typename?: 'PageInfo', startCursor: string | null, endCursor: string | null, hasNextPage: boolean, hasPreviousPage: boolean } } };
