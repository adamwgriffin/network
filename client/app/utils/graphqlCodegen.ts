 ...
 *
 * To run a mutation, you first call `useDestroyPostMutation` within a Vue
 * component and pass it any options that fit your needs. When your component
 * renders, `useDestroyPostMutation` returns an object that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - Several other properties: https://v4.apollo.vuejs.org/api/use-mutation.html#return
 *
 * @param options that will be passed into the mutation, supported options are
 ...
 *
 * To run a query within a Vue component, call `useGetCompanyQuery` and pass it
 * any options that fit your needs. When your component renders,
 * `useGetCompanyQuery` returns an object from Apollo Client that contains
 * result, loading and error properties you can use to render your UI.
 *
 ...
 * __useGetPostQuery__
 *
 * To run a query within a Vue component, call `useGetPostQuery` and pass it any
 * options that fit your needs. When your component renders, `useGetPostQuery`
 ...
 *
 * To run a query within a Vue component, call `useGetPostsQuery` and pass it
 * any options that fit your needs. When your component renders,
 * `useGetPostsQuery` returns an object from Apollo Client that contains result,
 ...
 *
 * To run a mutation, you first call `useUpdatePostMutation` within a Vue
 * component and pass it any options that fit your needs. When your component
 * renders, `useUpdatePostMutation` returns an object that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - Several other properties: https://v4.apollo.vuejs.org/api/use-mutation.html#return
 *
 * @param options that will be passed into the mutation, supported options are
