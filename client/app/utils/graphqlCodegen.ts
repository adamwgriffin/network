...
export type GetUsersToConnectWithQuery = { __typename?: 'Query', usersToConnectWith: { __typename?: 'UserConnection', edges: Array<{ __typename?: 'UserEdge', cursor: string, node: { __typename?: 'User', id: string, nameWithCredentials: string, slug: string } | null } | null> | null, pageInfo: { __typename?: 'PageInfo', endCursor: string | null, hasNextPage: boolean, hasPreviousPage: boolean, startCursor: string | null } } };
...
export const GetUsersToConnectWithDocument = gql`
    query GetUsersToConnectWith($userId: Int!, $first: Int = 10, $after: String = null) {
 ...
 * });
 */
export function useGetUsersToConnectWithQuery(variables: GetUsersToConnectWithQueryVariables | VueCompositionApi.Ref<GetUsersToConnectWithQueryVariables> | ReactiveFunction<GetUsersToConnectWithQueryVariables>, options: VueApolloComposable.UseQueryOptions<GetUsersToConnectWithQuery, GetUsersToConnectWithQueryVariables> | VueCompositionApi.Ref<VueApolloComposable.UseQueryOptions<GetUsersToConnectWithQuery, GetUsersToConnectWithQueryVariables>> | ReactiveFunction<VueApolloComposable.UseQueryOptions<GetUsersToConnectWithQuery, GetUsersToConnectWithQueryVariables>> = {}) {
  return VueApolloComposable.useQuery<GetUsersToConnectWithQuery, GetUsersToConnectWithQueryVariables>(GetUsersToConnectWithDocument, variables, options);
}
export function useGetUsersToConnectWithLazyQuery(variables?: GetUsersToConnectWithQueryVariables | VueCompositionApi.Ref<GetUsersToConnectWithQueryVariables> | ReactiveFunction<GetUsersToConnectWithQueryVariables>, options: VueApolloComposable.UseQueryOptions<GetUsersToConnectWithQuery, GetUsersToConnectWithQueryVariables> | VueCompositionApi.Ref<VueApolloComposable.UseQueryOptions<GetUsersToConnectWithQuery, GetUsersToConnectWithQueryVariables>> | ReactiveFunction<VueApolloComposable.UseQueryOptions<GetUsersToConnectWithQuery, GetUsersToConnectWithQueryVariables>> = {}) {
  return VueApolloComposable.useLazyQuery<GetUsersToConnectWithQuery, GetUsersToConnectWithQueryVariables>(GetUsersToConnectWithDocument, variables, options);
}
export type GetUsersToConnectWithQueryCompositionFunctionResult = VueApolloComposable.UseQueryReturn<GetUsersToConnectWithQuery, GetUsersToConnectWithQueryVariables>;
