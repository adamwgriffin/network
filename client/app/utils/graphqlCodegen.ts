...
export type GetUserQuery = { __typename?: 'Query', user: { __typename?: 'User', id: string, firstName: string, lastName: string, credentials: string | null, company: { __typename?: 'Company', id: string, name: string } } | null };
